...
{
    [Info("Realistic Weather", "OuTSMoKE", "1.1.3", ResourceId = 2519)]
        ...
        public Dictionary<string, Dictionary<int, List<string>>> Storms = new Dictionary<string, Dictionary<int, List<string>>>
                {
					...
					{"lightrain", new Dictionary<int, List<string>>
                    {
                        ...
                        {340, new List<string> { "weather.clouds 0.65" } },
						{360, new List<string> { "weather.clouds 0.7" } },
						{370, new List<string> { "weather.clouds 0.75" } },
