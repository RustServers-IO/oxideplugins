...
{
    [Info("EMSQL", "Steenamaroo", "0.0.1", ResourceId = 0)] 
    ...
    public static string RemoveSurrogatePairs(string str, string replacementCharacter = "?")
    {
        ...
        void LoadMySQL()
        {
            try
            {
                ...
                Sql.Insert(Core.Database.Sql.Builder.Append("CREATE TABLE IF NOT EXISTS emstatsdb( `UserID` VARCHAR(40) NOT NULL, `Name` VARCHAR(40) NOT NULL, `Kills` INT(11) NOT NULL, `Deaths` INT(11) NOT NULL, `GamesPlayed` INT(11) NOT NULL, `GamesWon` INT(11) NOT NULL, `GamesLost` INT(11) NOT NULL, `Score` INT(11) NOT NULL, `Rank` INT(11) NOT NULL, `FlagsCaptured` INT(11) NOT NULL, `ShotsFired` INT(11) NOT NULL, `ChoppersKilled` INT(11) NOT NULL, PRIMARY KEY (`UserID`) );"), Sql_conn);
