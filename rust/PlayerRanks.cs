...
{
    [Info("PlayerRanks", "Steenamaroo", "1.3.0", ResourceId = 2359)]
    ...
    {                                                              
        ...
        private ulong GetMajorityAttacker(uint id)
        {
            ...
            {
                Puts("contains the name, at least");
...
Connection Sql_conn;
        ...
        void LoadMySQL()
        {
            ...
            { 
                Puts("Player Ranks could not save the data.");    
            }
